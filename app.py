# app.py — Spectra AI Directory, version complète SEO + Stripe + sitemap + robots
...
def ajouter_tool():
    ...
    with get_db() as db:
        ...
        """, (name, url_site, short_description, long_description,
              logo_url, category, tags, created_at))
